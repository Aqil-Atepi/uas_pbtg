...
Object kolom []={"NIM", "Nama","Kelas", "Kode_Buku", "Nama_Buku", "Penerbit", "Tanggal_Peminjaman", "Tanggal_Pengembalian"};
...
Connection conn =DriverManager.getConnection("jdbc:mysql://127.0.0.1/database_database_perpustakaan", "root", "");
...
Object [] data={Nim,Nama,Kelas,Kode,Nabuk,Penerbit,tglp,tglk};
...
JOptionPane.showMessageDialog(this, "Error: "+ex);
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn =DriverManager.getConnection("jdbc:mysql://127.0.0.1/database_perpustakaan", "root", "");
            String sql="update karyawan set NIM=?,Nama=?,Kelas=?,Kode_Buku=?,Nama_Buku=?,Penerbit=?, Tanggal_Peminjaman=?,Tanggal_Pengembalian=?, where "+"NIM='"+nim.getText()+"'";
